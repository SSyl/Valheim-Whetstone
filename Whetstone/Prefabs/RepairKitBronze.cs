...
{
    public class RepairKitBronze : PrefabConfig
    {
        //Using flint as the base just for the model
        public RepairKitBronze() : base("RepairKitBronze", "Flint")
        {
        ...
        public override void Register()
        {
            ...
            item.m_itemData.m_shared.m_name = "Bronze Repair Kit";
            item.m_itemData.m_shared.m_description = "Repair kit with sharpening stone that can repair up to Bronze quality tools.\n\nRestores " + Whetstone.repairAmount.Value.ToString("P0").Replace(" ", "") + " durability to your equipped tool or weapon.";
            ...
            Texture2D icon = LoadedAssetBundle.LoadAsset<Texture2D>("repairkitbronze-sprite.png");
            if (icon != null)
            {
