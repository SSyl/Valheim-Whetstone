...
{
    public class RepairKitBlackMetal : PrefabConfig
    {
        //Using Obsidian as the base just for the model
        public RepairKitBlackMetal() : base("RepairKitBlackMetal", "Iron")
        {
        ...
        public override void Register()
        {
            ...
            Texture2D icon = LoadedAssetBundle.LoadAsset<Texture2D>("repairkitblackmetal-sprite.png");
            if (icon != null)
            {
