...
{
    public class RepairKitIron : PrefabConfig
    {
        //Using Iron as the base just for the model
        public RepairKitIron() : base("RepairKitIron", "Iron")
        {
        ...
        public override void Register()
        {
            ...
            item.m_itemData.m_shared.m_name = "Iron Repair Kit";
            item.m_itemData.m_shared.m_description = "Repair kit with sharpening stone that can repair up to Iron quality tools.\n\nRestores " + Whetstone.repairAmount.Value.ToString("P0").Replace(" ", "") + " durability to your equipped tool or weapon.";
            ...
            Texture2D icon = LoadedAssetBundle.LoadAsset<Texture2D>("repairkitiron-sprite.png");
            if (icon != null)
            {
